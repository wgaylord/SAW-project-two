function Checkers(){
	...
	*/
	...
	function initGame(color,sendUpdate,sendCapture){
		...
		[2,4,6,8,9,11,13,15,18,20,22,24].forEach(function(x){checkerState.board[x] = "opponentPiece";}); //Place opponents pieces
		[41,43,45,47,50,52,54,56,57,59,61,63].forEach(function(x){checkerState.board[x] = "piece";}); //Place your pieces
	...
	function registerClickHandlers(){
		[2,4,6,8,9,11,13,15,18,20,22,24,25,27,29,31,34,36,38,40,41,43,45,47,50,52,54,56,57,59,61,63].forEach(function(x){
		document.getElementById(x).addEventListener("click", function(){BoardClickHandler(x);});
		});
